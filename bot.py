    ...
    if 'channel_post' in data:
        ...
        if text.startswith('/start'):
            ...
            if len(parts) > 1:
                ...
                requests.get(f"{TELEGRAM_API_URL}/sendMessage", params={'chat_id': chat_id, 'text':আমাদের movieflix9u.onrender.com ওয়েবসাইটে আপনাকে স্বাগতম 🌹 আমাদের অপিসিয়াল চ্যানেলে জয়েন করুন @MovieFlix9u 🥰 আমাদের অপিসিয়াল গ্রুপে জয়েন করুন @MovieFlix9uChat 🥀 আমাদের চ্যানেলে ও গ্রুপে জয়েন করার জন্য আপনাকে ধন্যবাদ ❤️"})
